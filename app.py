...
def train_xgboost(
    ...
    """
    Train XGBClassifier with GridSearchCV for hyperparameter tuning.
    """
    ...
    param_grid = {
        ...
        "scale_pos_weight": [1.0, params.get("scale_pos_weight", 1.0)]
    }

    grid = GridSearchCV(
        estimator=base_model,
        param_grid=param_grid,
        scoring="f1",   # can change to "roc_auc" or "accuracy"
        cv=3,
        verbose=1,
        n_jobs=-1
    )
